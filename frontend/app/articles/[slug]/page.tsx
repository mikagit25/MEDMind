        ...
        <main>
          ...
          <div className="mb-8">
            ...
            {article.verification_status === "expert_verified" ? (
              ...
              <div className="mt-4 inline-flex items-center gap-2 bg-surface border border-border rounded-lg px-3 py-2">
                <span className="text-base">🤖</span>
                <div>
                  <div className="font-syne font-bold text-xs text-ink-2">AI-Generated · Evidence-Based</div>
                  <div className="font-serif text-[11px] text-ink-3">Based on AHA / ACC / ESC / WHO / NICE clinical guidelines</div>
                </div>
              </div>
            )}
          </div>
          ...
          <div className={`mt-10 rounded-xl px-5 py-5 border text-xs font-serif leading-relaxed ${
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                {(!article.verification_status || article.verification_status === "unverified") && (
                  <p className="text-ink-2">
                    🤖 This article was generated by AI based on established clinical guidelines
                    (AHA, ACC, ESC, WHO, NICE) and peer-reviewed medical literature.
                    Content is intended for <strong>educational purposes only</strong> — always verify
                    drug dosages and treatment protocols against current guidelines and consult
