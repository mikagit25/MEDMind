  ...
  return (
    <div className="min-h-screen bg-bg">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/login" className="hidden sm:block font-syne font-semibold text-sm text-ink-2 hover:text-ink transition-colors px-3 py-2">
              {t("how_it_works_page.nav_sign_in")}
            </Link>
            <Link href="/register" className="font-syne font-bold text-sm bg-ink text-white px-3 sm:px-4 py-2 rounded hover:bg-red transition-colors whitespace-nowrap">
              {t("how_it_works_page.nav_register")}
            </Link>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 pt-16 sm:pt-20 pb-12 sm:pb-16 text-center">
        ...
        <p className="text-ink-2 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed mb-8 sm:mb-10 px-2">
          {t("how_it_works_page.hero_desc")}
        </p>
        <Link href="/register" className="inline-block font-syne font-bold text-base bg-ink text-white px-8 sm:px-10 py-3.5 rounded hover:bg-red transition-colors">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <h2 className="font-syne font-bold text-2xl sm:text-3xl text-ink text-center mb-2 sm:mb-3">
          {t("how_it_works_page.steps_title")}
        </h2>
        <p className="text-ink-3 text-center mb-12 sm:mb-16 text-sm">
          {t("how_it_works_page.steps_note")}
        </p>
        <div className="space-y-10 sm:space-y-12">
          {(Array.isArray(steps) ? steps : []).map((step, i) => (
            <div key={step.number}
              className={`flex flex-col md:flex-row gap-6 sm:gap-8 items-start ${i % 2 === 1 ? "md:flex-row-reverse" : ""}`}>
      ...
      <section className="bg-surface border-y border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14 sm:py-20">
          <h2 className="font-syne font-bold text-2xl sm:text-3xl text-ink text-center mb-2 sm:mb-3">
            {t("how_it_works_page.roles_section_title")}
          </h2>
          <p className="text-ink-3 text-center mb-10 sm:mb-12 text-sm">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-14 sm:py-20">
        <h2 className="font-syne font-bold text-2xl sm:text-3xl text-ink text-center mb-2 sm:mb-3">
          {t("how_it_works_page.tech_title")}
        </h2>
        <p className="text-ink-3 text-center mb-10 sm:mb-12 text-sm">
          {t("how_it_works_page.steps_note")}
        </p>
      ...
      <section className="bg-ink text-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          <h2 className="font-syne font-extrabold text-3xl sm:text-4xl mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/register"
              className="inline-block font-syne font-bold text-base bg-white text-ink px-8 sm:px-10 py-4 rounded hover:bg-red hover:text-white transition-colors text-center">
              {t("how_it_works_page.cta_btn")}
            </Link>
            <Link href="/pricing"
              className="inline-block font-syne font-semibold text-base border border-white/30 text-white/80 px-8 sm:px-10 py-4 rounded hover:border-white hover:text-white transition-colors text-center">
              {t("how_it_works_page.nav_pricing")}
            </Link>
          </div>
        </div>
