...
const CONTACT_DATA: Record<TrustLocale, Omit<ContactT, keyof TrustT>> = {
  en: {
    ...
    meta_desc: "Contact the MedMind AI founder or company for partnerships, inquiries, or content feedback.",
  ...
  ru: {
    ...
    meta_desc: "Свяжитесь с основателем или компанией MedMind AI по вопросам партнёрства или обратной связи.",
  ...
  de: {
    ...
    meta_desc: "Kontaktieren Sie den Gründer oder das Unternehmen MedMind AI für Partnerschaften oder Anfragen.",
    hero_title: "Kontakt",
  ...
  fr: {
    ...
    meta_desc: "Contactez le fondateur ou l'entreprise MedMind AI pour des partenariats ou des demandes.",
  ...
  es: {
    ...
    meta_desc: "Contacte al fundador o la empresa MedMind AI para asociaciones o consultas.",
  ...
  tr: {
    ...
    meta_desc: "Ortaklıklar veya sorular için MedMind AI kurucusuyla veya şirketiyle iletişime geçin.",
  ...
  ar: {
    ...
    meta_desc: "تواصل مع مؤسس MedMind AI أو الشركة للشراكات أو الاستفسارات.",
