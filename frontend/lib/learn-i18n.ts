...
export interface LearnStrings {
  ...
  cta_start: string;
  cta_back: string;
  breadcrumb_topics: string;
  disclaimer_prefix: string;
  drug_class_prefix: string;
}
...
const translations: Record<LearnLocale, LearnStrings> = {
  ...
  en: {
    ...
    key_terms: "Key Terms",
    cta_title: "Learn {topic} interactively",
    cta_desc: "AI tutor, flashcards, quizzes, and clinical cases — personalized to your level.",
    cta_start: "Start for Free →",
    cta_back: "Back to {topic}",
    breadcrumb_topics: "Topics",
    disclaimer_prefix: "Educational content only.",
    drug_class_prefix: "Class:",
  ...
  ru: {
    ...
    cta_title: "Изучайте {topic} интерактивно",
    cta_desc: "ИИ-репетитор, флэшкарты, тесты и клинические кейсы — персонализированные под ваш уровень.",
    cta_start: "Начать бесплатно →",
    cta_back: "Вернуться к {topic}",
    breadcrumb_topics: "Темы",
    disclaimer_prefix: "Только образовательный контент.",
    drug_class_prefix: "Класс:",
  ...
  ar: {
    ...
    min_read: "{n} دقيقة قراءة",
    next_lesson: "الدرس التالي",
    prev_lesson: "الدرس السابق",
    key_takeaways: "النقاط الرئيسية",
    key_terms: "المصطلحات الرئيسية",
    cta_title: "تعلّم {topic} بشكل تفاعلي",
    cta_desc: "معلم الذكاء الاصطناعي وبطاقات الفلاش والاختبارات والحالات السريرية — مخصصة لمستواك.",
    cta_start: "ابدأ مجاناً →",
    cta_back: "العودة إلى {topic}",
    breadcrumb_topics: "المواضيع",
    disclaimer_prefix: "للأغراض التعليمية فقط.",
    drug_class_prefix: "الفئة:",
  ...
  tr: {
    ...
    key_takeaways: "Temel Çıkarımlar",
    key_terms: "Temel Terimler",
    cta_title: "{topic} konusunu etkileşimli öğrenin",
    cta_desc: "Yapay zeka öğretmeni, flash kartlar, testler ve klinik vakalar — seviyenize göre kişiselleştirilmiş.",
    cta_start: "Ücretsiz Başla →",
    cta_back: "{topic} konusuna geri dön",
    breadcrumb_topics: "Konular",
    disclaimer_prefix: "Yalnızca eğitim amaçlıdır.",
    drug_class_prefix: "Sınıf:",
  ...
  de: {
    ...
    cta_title: "{topic} interaktiv lernen",
    cta_desc: "KI-Tutor, Lernkarten, Quiz und klinische Fälle — personalisiert auf Ihr Niveau.",
    cta_start: "Kostenlos starten →",
    cta_back: "Zurück zu {topic}",
    breadcrumb_topics: "Themen",
    disclaimer_prefix: "Nur für Bildungszwecke.",
    drug_class_prefix: "Klasse:",
  ...
  fr: {
    ...
    cta_title: "Apprendre {topic} de manière interactive",
    cta_desc: "Tuteur IA, cartes mémoire, quiz et cas cliniques — personnalisés à votre niveau.",
    cta_start: "Commencer gratuitement →",
    cta_back: "Retour à {topic}",
    breadcrumb_topics: "Sujets",
    disclaimer_prefix: "Contenu éducatif uniquement.",
    drug_class_prefix: "Classe :",
  ...
  es: {
    ...
    cta_title: "Aprende {topic} de forma interactiva",
    cta_desc: "Tutor de IA, tarjetas de memoria, cuestionarios y casos clínicos — personalizados a tu nivel.",
    cta_start: "Empezar gratis →",
    cta_back: "Volver a {topic}",
    breadcrumb_topics: "Temas",
    disclaimer_prefix: "Solo contenido educativo.",
    drug_class_prefix: "Clase:",
...
// ── Drug class translations ───────────────────────────────────────────────────

const DRUG_CLASS_RU: Record<string, string> = {
  "ACE Inhibitor": "Ингибитор АПФ",
  "Angiotensin-converting Enzyme Inhibitors": "Ингибиторы АПФ",
  "Adrenergic beta-Antagonists": "Бета-адреноблокаторы",
  "Adrenergic beta2-Agonists": "Бета2-агонисты",
  "Adrenergic alpha-Antagonists": "Альфа-адреноблокаторы",
  "Aldosterone Antagonist": "Антагонист альдостерона",
  "Aldosterone Antagonists": "Антагонисты альдостерона",
  "Angiotensin Receptor Blocker": "Блокатор рецепторов АТ",
  "Angiotensin 2 Receptor Antagonists": "Антагонисты АТ2-рецепторов",
  "Angiotensin Receptor-Neprilysin Inhibitor": "Ингибитор АРНИ",
  "Antiarrhythmic": "Антиаритмик",
  "Class IC Antiarrhythmic": "Антиаритмик IC класса",
  "Class III Antiarrhythmic": "Антиаритмик III класса",
  "Antiepileptics": "Антиэпилептическое",
  "Antifungal": "Противогрибковое",
  "Azole Antifungal": "Азоловый антифунгал",
  "Allylamine Antifungal": "Аллиламиновый антифунгал",
  "Echinocandin Antifungal": "Эхинокандин",
  "Polyene Antifungal": "Полиеновый антифунгал",
  "Pyrimidine Antifungal": "Пиримидиновый антифунгал",
  "Anti-inflammatory": "Противовоспалительное",
  "Aminoglycoside": "Аминогликозид",
  "Aminoglycoside Antibacterial": "Аминогликозид",
  "Aminomethylcycline Tetracycline": "Тетрациклин (аминометилциклин)",
  "Benzodiazepine": "Бензодиазепин",
  "Beta-lactam / Beta-lactamase Inhibitor": "Бета-лактам / ингибитор лактамазы",
  "Beta-lactam / Beta-lactamase Inhibitor Combination": "Бета-лактам / ингибитор лактамазы",
  "Antipseudomonal Penicillin / Beta-lactamase Inhibitor": "Антипсевдомонадный пенициллин / ингибитор лактамазы",
  "Calcium Channel Antagonists": "Блокаторы кальциевых каналов",
  "Dihydropyridine Calcium Channel Blocker": "БКК дигидропиридин",
  "Carbapenem": "Карбапенем",
  "Carbapenems": "Карбапенемы",
  "Carbapenem / Beta-lactamase Inhibitor": "Карбапенем / ингибитор лактамазы",
  "Cardiac Glycoside": "Сердечный гликозид",
  "Cephalosporin Antibacterial": "Цефалоспорин",
  "First Generation Cephalosporin": "Цефалоспорин I поколения",
  "Second Generation Cephalosporin": "Цефалоспорин II поколения",
  "Third Generation Cephalosporin": "Цефалоспорин III поколения",
  "Siderophore Cephalosporin": "Цефалоспорин-сидерофор",
  "Chelating Activity": "Хелатирующее",
  "Cholesterol Absorption Inhibitor": "Ингибитор всасывания холестерина",
  "Corticosteroid": "Кортикостероид",
  "Corticosteroid Hormone Receptor Agonists": "Кортикостероид",
  "Cyclooxygenase Inhibitors": "Ингибиторы ЦОГ (НПВС)",
  "Direct Thrombin Inhibitor": "Прямой ингибитор тромбина",
  "Thrombin Inhibitors": "Ингибиторы тромбина",
  "Direct Vasodilator": "Прямой вазодилататор",
  "Vasodilation": "Вазодилататор",
  "Dopamine D2 Antagonists": "Антагонист D2-рецепторов",
  "Factor Xa Inhibitor": "Ингибитор фактора Xa",
  "Factor Xa Inhibitors": "Ингибиторы фактора Xa",
  "Fibric Acid Derivative": "Производное фиброевой кислоты (фибрат)",
  "Fluoroquinolone": "Фторхинолон",
  "Fluoroquinolone Antibacterial": "Фторхинолон",
  "Quinolone Antimicrobial": "Хинолон",
  "Fluorocycline Tetracycline": "Тетрациклин (флуороциклин)",
  "Glycopeptide Antibacterial": "Гликопептид",
  "Lipoglycopeptide": "Липогликопептид",
  "GPIIb/IIIa Inhibitor": "Ингибитор GP IIb/IIIa",
  "HMG-CoA Reductase Inhibitor": "Статин",
  "Hydroxymethylglutaryl-CoA Reductase Inhibitors": "Статин",
  "HIV Integrase Inhibitors": "Ингибиторы интегразы ВИЧ",
  "HIV Protease Inhibitors": "Ингибиторы протеазы ВИЧ",
  "Histamine H2 Receptor Antagonists": "Блокаторы H2-рецепторов гистамина",
  "If Channel Blocker": "Блокатор If-каналов",
  "Increased Diuresis": "Диуретик",
  "Increased Diuresis at Loop of Henle": "Петлевой диуретик",
  "Increased Large Intestinal Motility": "Стимулятор моторики толстой кишки",
  "Stimulation Large Intestine Fluid/Electrolyte Secretion": "Слабительное (секреторное)",
  "Laxatives": "Слабительное",
  "Late Sodium Channel Blocker": "Блокатор поздних Na-каналов",
  "Lincosamide": "Линкозамид",
  "Lipid-lowering Agent": "Гиполипидемическое",
  "Lipopeptide": "Липопептид",
  "Loop Diuretic": "Петлевой диуретик",
  "Low Molecular Weight Heparin": "НМГ (низкомолекулярный гепарин)",
  "Unfractionated Heparin": "НФГ (нефракционированный гепарин)",
  "Macrolide": "Макролид",
  "Macrolide Antimicrobial": "Макролид",
  "Monobactam": "Монобактам",
  "Penem Antibacterial": "Пенем",
  "Neuraminidase Inhibitor": "Ингибитор нейраминидазы",
  "Neuraminidase Inhibitors": "Ингибиторы нейраминидазы",
  "Nicotinic Acid": "Никотиновая кислота",
  "Nitrofuran": "Нитрофурановое",
  "Nitroimidazole": "Нитроимидазол",
  "Nitroimidazole / Antitubercular": "Нитроимидазол / противотуберкулёзное",
  "Antitubercular": "Противотуберкулёзное",
  "ATP Synthase Inhibitor / Antitubercular": "Ингибитор АТФ-синтазы / противотуберкулёзное",
  "RNA Polymerase Inhibitor": "Ингибитор РНК-полимеразы",
  "DNA Polymerase Inhibitors": "Ингибиторы ДНК-полимеразы",
  "Non-Nucleoside Reverse Transcriptase Inhibitors": "ННИОТ",
  "Nucleoside Reverse Transcriptase Inhibitors": "НИОТ",
  "Nucleotide Analogue Antiviral": "Нуклеотидный аналог (противовирусное)",
  "Pyrophosphate Analogue Antiviral": "Пирофосфатный аналог (противовирусное)",
  "Cap-dependent Endonuclease Inhibitor": "Ингибитор кэп-зависимой эндонуклеазы",
  "CMV Terminase Inhibitor": "Ингибитор терминазы ЦМВ",
  "UL97 Kinase Inhibitor": "Ингибитор киназы UL97",
  "Non-steroidal Mineralocorticoid Receptor Antagonist": "Нестероидный антагонист МКР",
  "Norepinephrine Uptake Inhibitors": "Ингибиторы захвата норэпинефрина",
  "Opioid Agonists": "Опиоидные агонисты",
  "Full Opioid Agonists": "Полные опиоидные агонисты",
  "Partial Opioid Agonists": "Частичные опиоидные агонисты",
  "Opioid Antagonists": "Опиоидные антагонисты",
  "Oxazolidinone": "Оксазолидинон",
  "Oxazolidinone Antibacterial": "Оксазолидинон",
  "P2Y12 Receptor Antagonist": "Антагонист P2Y12",
  "PAR-1 Antagonist": "Антагонист PAR-1",
  "Platelet Aggregation Inhibitor": "Антиагрегант",
  "Decreased Platelet Aggregation": "Антиагрегант",
  "PCSK9 Inhibitor": "Ингибитор PCSK9",
  "PCSK9 siRNA": "PCSK9 siRNA",
  "PDE5 Inhibitor": "Ингибитор ФДЭ-5",
  "Penicillin-class Antibacterial": "Пенициллин",
  "Penicillins": "Пенициллины",
  "Phenicol": "Фениколовое антибиотическое",
  "Phenothiazine": "Фенотиазин",
  "Phosphonic Acid Antibiotic": "Фосфоновое антибиотическое",
  "Polymyxin": "Полимиксин",
  "Proton Pump Inhibitors": "Ингибиторы протонной помпы",
  "Rifamycin": "Рифамицин",
  "Serotonin 3 Receptor Antagonists": "Антагонисты 5-HT3-рецепторов",
  "Serotonin Reuptake Inhibitor": "Ингибитор обратного захвата серотонина",
  "Serotonin Uptake Inhibitors": "Ингибиторы захвата серотонина",
  "SGLT2 Inhibitor": "Ингибитор НГЛТ-2",
  "SGLT1/2 Inhibitor": "Ингибитор НГЛТ-1/2",
  "Soluble Guanylate Cyclase Stimulator": "Стимулятор растворимой гуанилатциклазы",
  "Sulfonamide Combination": "Сульфаниламид (комбо)",
  "Tetracycline-class Antibacterial": "Тетрациклин",
  "Tetracycline-class Antimicrobial": "Тетрациклин",
  "Tetracycline-class Drug": "Тетрациклин",
  "Thiazide-like Diuretic": "Тиазидоподобный диуретик",
  "Thrombolytic": "Тромболитик",
  "Tricyclic Antidepressant": "Трициклический антидепрессант",
  "Atypical Antidepressants": "Атипичный антидепрессант",
  "Typical Antipsychotic": "Типичный антипсихотик",
  "Atypical Antipsychotic": "Атипичный антипсихотик",
  "Vitamin K Antagonist": "Антагонист витамина К",
  "Adenosine Receptor Agonists": "Агонисты аденозиновых рецепторов",
  "Cytochrome P450 1A2 Inhibitors": "Ингибиторы CYP1A2",
  "Dihydrofolate Reductase Inhibitors": "Ингибиторы ДГФР",
  "Endothelin Receptor Antagonist": "Антагонист эндотелиновых рецепторов",
  "Decreased Central Nervous System Disorganized Electrical Activity": "Противоэпилептическое",
  "Decreased Renal K+ Excretion": "Калийсберегающий диуретик",
  "Decreased Sebaceous Gland Activity": "Ингибитор сальных желёз",
};

export function translateDrugClass(className: string | null | undefined, locale: string): string {
  if (!className) return "";
  if (locale === "ru") return DRUG_CLASS_RU[className] ?? className;
  return className;
}
