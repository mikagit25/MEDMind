...
TOPICS: dict[str, list[str]] = {
    ...
    "anatomy": [
        "Brachial Plexus Anatomy", "Femoral Triangle Contents",
        "Coronary Artery Anatomy", "Circle of Willis",
        "Hepatic Portal System", "Lymphatic Drainage of the Breast",
        "Pelvic Floor Anatomy", "Carpal Tunnel Anatomy",
        "Cranial Nerve Functions", "Autonomic Nervous System",
        "Renal Blood Supply", "Biliary System Anatomy",
        "Knee Joint Anatomy", "Shoulder Joint Anatomy",
        "Vertebral Column Anatomy", "Thoracic Outlet",
    ],
}
